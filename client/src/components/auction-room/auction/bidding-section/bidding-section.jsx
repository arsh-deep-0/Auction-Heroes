    ...
    <>
      <div className="w-full h-full  flex flex-col p-4 gap-4">
        ...
        <div className="w-full grid grid-cols-3 gap-1">
          ...
          <div className="bg-white rounded-xl pink-shadow mx-2">
            <p className="gabriela text-black text-center bar-text p-2">₹ <span className="bid-amount-text">5.2</span> Cr</p>
          </div>
